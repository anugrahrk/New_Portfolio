  ...
  return (
    <div>
      ...
      <div className='md:flex md:justify-between p-1' >
        <div className='absolute w-[350px] md:ml-15  top-35 dark:text-white  place-self-center border border-gray-200 dark:border-gray-700 md:w-150 md:h-106  rounded-2xl m-2 p-10 md:pt-14 backdrop-blur-sm'>
        ...
        <div className='relative top-140 md:p-11 md:left-1/2 md:top-35 md:w-150 dark:text-white  place-self-center border border-gray-200 dark:border-gray-700 rounded-2xl p-8 w-[350px] ml-3 mr-3 backdrop-blur-sm mb-1'>
          <div className='pr-3'>
